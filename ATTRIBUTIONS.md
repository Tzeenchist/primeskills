...
primeskills is MIT (see `LICENSE`). It was synthesised from six sources, and
...
| [andrej-karpathy-skills](https://github.com/karpathy/karpathy-skills) | MIT | Andrej Karpathy | §2 Simplicity First and §3 Surgical Changes are in `core/PRINCIPLES.md` close to verbatim; §1 and §4 condensed |
...
- **Published system prompts of claude.ai** (Anthropic) — four rules adopted 2026-08-17: formatting density, prose when declining, checking for a capability before saying you lack it, judging edit radius cumulatively. See PS-017.
