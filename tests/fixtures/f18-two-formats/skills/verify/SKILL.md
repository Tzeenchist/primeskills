...
## Invariants
- A command passes only when the exit code is zero and the tool signals
  success in its output; absence of a crash never counts as passing (G4).
- Never edit tests or thresholds to make a build green (PRINCIPLES 3).
