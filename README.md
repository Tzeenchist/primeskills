...
контекста и без телеметрии. Скиллы плюс общая база `core/`; точный состав и вес
печатает `python3 bin/primeskills-status`. Против ≈ 92 000 слов у одного прохода
gstack — замер в `bench/RESULT.md`.
