...
Установщик кладёт символические ссылки — записи, указывающие на файл в этом
репозитории, — поэтому правка сразу действует у всех агентов. Если это лишнее,
закрепите набор на коммите:

```
python3 bin/primeskills-install --pin HEAD   # агенты читают закреплённое дерево
...
работ. Версия 0.1.0: набор работает, но ещё не доказал себя замером на живых
